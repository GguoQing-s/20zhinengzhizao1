...
public class Sgxz1 extends LitePalSupport {
    private String name,xh,gys,shuliang,yuliang,dj,weizhi,caigoyuan,lianxiren,zhanghao,ren,time,path;

    public Sgxz1(String name, String xh, String gys, String shuliang, String yuliang, String dj, String weizhi, String caigoyuan, String lianxiren, String zhanghao, String ren, String time, String path) {
        this.name = name;
        this.xh = xh;
        this.gys = gys;

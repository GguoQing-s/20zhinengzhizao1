...
public class Arkrxadapter extends BaseExpandableListAdapter {
    private List<String> fu;
    private Map<String,List<String>> zi;
    public Arkrxadapter(List<String> fu, Map<String,List<String>> zi)
    {
        this.fu=fu;
        this.zi=zi;
    }
    public interface  SetData{
        void setdata(String xh,String sj,String sl,String gys,String ylmc);
    }
    public SetData data;
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        textView2.setText("型号："+zz[1]);
        textView3.setText("时间："+zz[2]);
        textView4.setText("数量："+zz[3]);
        textView5.setText("供应商："+zz[4]);

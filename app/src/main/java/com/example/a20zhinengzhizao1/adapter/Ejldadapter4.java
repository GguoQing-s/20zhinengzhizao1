...
public class Ejldadapter4 extends BaseExpandableListAdapter {
    private List<String> fu;
    private Map<String,List<String>> zi;
    public Ejldadapter4(List<String> fu, Map<String,List<String>> zi)
    {
        this.fu=fu;
        this.zi=zi;
    }
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        textView.setText("交易时间："+zzz[1]+"  金额："+zzz[2]);
        return convertView;
    }

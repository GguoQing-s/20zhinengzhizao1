...
public class Aylcxchadapter extends BaseExpandableListAdapter {
    private List<String> fu;
    private Map<String,List<String>> zi;
    public Aylcxchadapter(List<String> fu, Map<String,List<String>> zi)
    {
        this.fu=fu;
        this.zi=zi;
    }
    public interface  SetData{
        void setdata(String xh, String sj, String sl, String chr, String jsr);
    }
    public SetData data;
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        final List<String> z = zi.get(fu.get(groupPosition));
        ...
        textView1.setText("出货型号："+zz[0]);
        textView2.setText("出货时间："+zz[1]);
        textView3.setText("出货数量："+zz[2]);
        textView4.setText("出货人："+zz[3]);
        textView5.setText("接收人："+zz[4]);
        linearLayout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                data.setdata(zz[0],zz[1],zz[2],zz[3],zz[4]);
            }
        });
        return convertView;
    }

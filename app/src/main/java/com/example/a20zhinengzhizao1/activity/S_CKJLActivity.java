...
import com.example.a20zhinengzhizao1.adapter.Ackrxadapter;
import com.example.a20zhinengzhizao1.adapter.Arkrxadapter;
import com.example.a20zhinengzhizao1.adapter.Aylcxadapter;
import com.example.a20zhinengzhizao1.adapter.Aylcxchadapter;
import com.example.a20zhinengzhizao1.adapter.Fladapter;
import com.example.a20zhinengzhizao1.adapter.Qbjchladapter;
import com.example.a20zhinengzhizao1.adapter.Qbjladapter;
import com.example.a20zhinengzhizao1.bean.Chjl;
import com.example.a20zhinengzhizao1.bean.Chjl1;
import com.example.a20zhinengzhizao1.bean.Rkjl;
import com.example.a20zhinengzhizao1.bean.Rkjl1;
import com.example.a20zhinengzhizao1.dialog.Rl_Dialog;
...
public class S_CKJLActivity extends AppCompatActivity {
    ...
    private Aylcxchadapter aylcxadapter;
    ...
    private void setadapter3() {
        ...
        arkrxadapter.SetData(new Ackrxadapter.SetData() {
            ...
            public void setdata(String xh, String sj, String sl, String chr, String ylmc) {
                Intent intent = new Intent(S_CKJLActivity.this,S_CHXSXQActivity.class);
    ...
    private void setadapter2() {
        aylcxadapter = new Aylcxchadapter(fu, zi);
        ex.setAdapter(aylcxadapter);
        aylcxadapter.SetData(new Aylcxchadapter.SetData() {
            @Override
    ...
    @OnClick({R.id.start1, R.id.end1, R.id.qk})

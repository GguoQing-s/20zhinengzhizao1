...
import com.example.a20zhinengzhizao1.adapter.Sgxzadapter;
import com.example.a20zhinengzhizao1.adapter.Zchladapter;
import com.example.a20zhinengzhizao1.bean.He;
import com.example.a20zhinengzhizao1.bean.Sgxz;
import com.example.a20zhinengzhizao1.bean.Sgxz1;
...
public class S_CKActivity extends AppCompatActivity {
    ...
    private String index = "", xh1 = "", ylmc1 = "", path = "";
                ...
                .setVolleyLo(new VolleyLo() {
                    ...
                    public void onResponse(JSONObject jsonObject) {
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            ...
                            if (ylmc1.equals(jsonObject1.optString("name"))) {
    ...
    private void jiesho() {
        ylmc1 = getIntent().getStringExtra("name");
    ...
    @OnClick({R.id.sgxz, R.id.qd, R.id.yi, R.id.er, R.id.san, R.id.si,R.id.chjl})
        ...
        switch (view.getId()) {
            ...
            case R.id.qd:
                ...
                qd.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        addData(ylmc1, xh1, sun + "", t, AppClient.getName(), jsr.getText().toString(), "济南", index);
                        dialog.dismiss();
                    }
                });
            ...
            case R.id.si:
                ...
                break;
            case R.id.chjl:
               startActivity(new Intent(S_CKActivity.this,S_CKJLActivity.class));
                break;
        }
    }
}

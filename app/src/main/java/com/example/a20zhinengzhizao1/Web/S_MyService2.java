        ...
        try {
            switch (url) {
                case "/get_jl":
                    ...
                    return Response.newFixedLengthResponse(Status.OK, "application/json", jsonObject54.toString());
                ...
                case "/set_tj":
                    ...
                    return Response.newFixedLengthResponse(Status.OK, "application/json", jsonObject52.toString());
                case "/add_ygxx_info":
                        session.parseBody(map);
                        bodyJson = new JSONObject(map.get("postData"));
                    try {

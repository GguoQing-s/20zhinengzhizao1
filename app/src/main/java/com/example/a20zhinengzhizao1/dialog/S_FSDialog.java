...
public class S_FSDialog extends DialogFragment {
    ...
    private String path,t,name;
    public S_FSDialog(String name,String t)
    {
        this.name=name;
        this.t=t;
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.yp_dialog, null);
    ...
    private void add() {
        ...
        volleyTo.setUrl("set_factory_application")
                .setJsonObject("username",AppClient.getName()+"-"+name)
                ...
                .setVolleyLo(new VolleyLo() {
                    ...
                    public void onResponse(JSONObject jsonObject) {
                        ...
                        for (int i=0;i<jsonArray.length();i++)
                        {
                            ...
                            if (aa[1].equals(name)&&AppClient.getName().equals(aa[0]))
                            {

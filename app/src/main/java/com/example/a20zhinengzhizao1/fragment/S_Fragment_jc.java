...
public class S_Fragment_jc extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.s_fragment_jc, null);
    ...
    private void setadapter() {
        ...
        mjcadapter.SetData(new Jcadapter.SetData() {
            @Override
            public void setdata(int position, String name, String clxh, String jb, String cs,
                                String lx, String hbbz, String sssj, String jg, String sl,
                                String sms, String cspz, String video, String image) {
